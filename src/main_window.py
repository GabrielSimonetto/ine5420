...
from src.new_wireframe_window import NewWireframeWindow
from src.transform_window import TransformWindow
from src.utils import (
    CoordinatesRepresentation,
)
from src.math_functions import transform_coordinates, build_window_normalizations
from src.clipping import clip
...
from src.obj_handler import ObjLoader, ObjWriter
from src.wireframe import Wireframe, Curve, WireframeGroup
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def set_buttons_actions(self):
        ...
        self.console_print("Program initialized")
    ...
    def redraw_wireframes(self):
        self.console_print(f"Drawing {len(self.display_file)} wireframes")
        self.clear_canvas()
        self.prepare_normalization_matrix()
